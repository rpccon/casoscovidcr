...
const ContactShare = () => (
  <div className={"contact-information"}>
    <div className={"developed"}>
      ...
      <div className={"icons"}>
        <a target="_blank" rel="noopener noreferrer" href="https://www.facebook.com/roberto.salazar.752"><img src={facebookIcon} alt="" /></a>
        <a target="_blank" rel="noopener noreferrer" href="https://www.linkedin.com/in/roberto-salazar-mel%C3%A9ndez-49a58015b/"><img src={linkedinIcon} alt="" /></a>
      </div>
    </div>
    <div className={"share"}>
